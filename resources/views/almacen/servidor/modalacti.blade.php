...
{{Form::open(array('action'=>array('ServidorController@cambiar',$ser->ipInterna),'method'=>'delete'))}}
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Activar Servidor</h4>
        </div>

        <div class="modal-body">
            <p>Confirme Si Desea Activar el Servidor</p>
        </div>
